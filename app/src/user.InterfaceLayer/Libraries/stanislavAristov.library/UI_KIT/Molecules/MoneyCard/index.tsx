...
const MoneyCard: FC<IMoneyCardProps | ICardDTO> = ({balance, bank,type,createDate, number}) => {
    ...
    return (
        <ST.MoneyCardWrapper>
            <ST.Header>
                <Typography_Montserrat_Bold className={EFontClasses.MainTextMont24_28_413_900} color={Colors.WHITE} text={"$"+balance}/>
                <Typography_Montserrat_Bold className={EFontClasses.SecondaryTextPTSanBold15_18_413_900} color={Colors.WHITE} text={type}/>
            </ST.Header>
            <ST.Footer>
                <Typography_Montserrat_Normal color ={Colors.WHITE} className={EFontClasses.SecondaryText14_16_413_900} text={createDate}/>
                <ST.Private>
                    <Typography_Montserrat_Normal color ={Colors.WHITE} className={EFontClasses.SecondaryText14_16_413_900} text={privateNumber}/>
