...
const Typography_Montserrat_Bold :FC<ITypographySimpleType> = ({as,text, color,className}) => {
    return (
        <Typography
...
Typography_Montserrat_Bold.defaultProps = {
    color:Colors.BLACK,
    className:EFontClasses.MainTextMont30_45_413_900,
    as:"h1"
};
export default Typography_Montserrat_Bold;