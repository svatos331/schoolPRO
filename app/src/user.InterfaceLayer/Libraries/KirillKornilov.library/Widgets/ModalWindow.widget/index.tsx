...
const ModalWindowWidget: FunctionComponent<ModalWindowWidgetType> = ({ 
    ...
    const month = (datetime.getMonth()+1).toString().length > 1 ? (datetime.getMonth()+1 ): "0" + (datetime.getMonth()+1);
    const day = (datetime.getDate()+1).toString().length > 1 ? (datetime.getDate()+1) : "0" + (datetime.getDate()+1);
...
const handleAddTask= async ()=>{
	...
	//alert(data);
		...
		return (
			<div className="modal-base" style={visible?{display: "flex"}:{display:"none"}} >
				...
				<div className='modal-parameters'>
					...
					<div>
						...
						<div className="sd-container">
							<input className="sd" type="date" name="selected_date" value={valueDate} onChange={(e)=>setValueDate(e.target.value)}/>
